...
import React, { type ReactNode, useState, useCallback, useEffect, useRef, forwardRef } from 'react'
...
function DocPageContent({ currentDocRoute, versionMetadata, children, sidebarName }: DocPageContentProps): JSX.Element {
  ...
  return (
    <Layout
      // image={}  // 必要なパラメタを用意してURLをつくると `og:image` になる
        ...
        >
          <div
            className={clsx(
              ...
              'container padding-top--md padding-bottom--lg znc',
