...
function TagsRow(props: TagsListInlineProps) {
  return (
    <div className={clsx(ThemeClassNames.docs.docFooterTagsRow, 'row margin-bottom--md')}>
      <div className='col'>
...
>
function EditMetaRow({ editUrl, lastUpdatedAt, lastUpdatedBy, formattedLastUpdatedAt }: EditMetaRowProps) {
  return (
    <div className={clsx(ThemeClassNames.docs.docFooterEditMetaRow, 'row')}>
      ...
      <div className='col col--4 margin-vert--sm'>
        <div className='row'>
          {editUrl && (
            <div className={clsx('col col--12', styles.editThisPage)}>
              <EditThisPage editUrl={editUrl} text='Edit Request' />
            </div>
          )}
